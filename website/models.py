...
class Empleados(models.Model):
    ...
    UsuarioAlta = models.ForeignKey('Usuarios',to_field = 'IdUsuario',related_name='usuarioAltaEmpleados',on_delete=models.PROTECT,db_column="UsuarioAlta",blank=True)
    FechaAlta = models.DateField(auto_now_add=True)
    HoraAlta = models.TimeField(auto_now_add=True)
    UsuarioCambio = models.ForeignKey('Usuarios',to_field = 'IdUsuario',related_name='usuarioCambioEmpleados',on_delete=models.PROTECT,db_column="UsuarioCambio",null=True)
...
class Usuarios(models.Model):
    ...
    UsuarioAlta = models.ForeignKey('self',to_field = 'IdUsuario',related_name='usuarioAltaUsuarios',on_delete=models.PROTECT,db_column="UsuarioAlta",blank=True)
    FechaAlta = models.DateField(auto_now_add=True)
    HoraAlta = models.TimeField(auto_now_add=True)
    UsuarioCambio = models.ForeignKey('self',to_field = 'IdUsuario',related_name='usuarioCambioUsuarios',on_delete=models.PROTECT,db_column="UsuarioCambio",null=True)
    FechaCambio = models.DateField(auto_now=True,null=True)
    HoraCambio = models.TimeField(auto_now=True,null=True)
    EstadoLogico = models.IntegerField()
    Version = models.IntegerField()
