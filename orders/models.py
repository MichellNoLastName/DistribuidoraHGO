...
class OrdenesCliente(models.Model):
    ...
    CorreoElectronicoOrdenCliente = models.ForeignKey(ContactoMedios,related_name='correosOrdenesCliente',to_field='IdContactoMedio',on_delete=models.PROTECT,db_column='CorreoElectronicoOrdenCliente',null=True,blank=True)
    NumeroTelefonicoOrdenCliente = models.ForeignKey(ContactoMedios,related_name='telefonosOrdenesCliente',to_field='IdContactoMedio',on_delete=models.PROTECT,db_column='NumeroTelefonicoOrdenCliente',null=True)
    CodigoPostalOrdenCliente = models.ForeignKey(CodigosPostales,related_name='cpOrdenesCliente',to_field='IdCodigoPostal',on_delete=models.PROTECT,db_column='CodigoPostalOrdenCliente')
    EntidadFederativaOrdenCliente = models.ForeignKey(EntidadesFederativas,related_name='entidadesFederativasOrdenesCliente',to_field='IdEntidadFederativa',on_delete=models.PROTECT,db_column='EntidadFederativaOrdenCliente')
    LocalidadOrdenCliente = models.ForeignKey(Localidades,related_name='localidadesOrdenesCliente',to_field='IdElementoLocalidad',on_delete=models.PROTECT,db_column='LocalidadOrdenCliente')
    ColoniaOrdenCliente = models.ForeignKey(Colonias,related_name='coloniasOrdenesCliente',to_field='IdElementoColonia',on_delete=models.PROTECT,db_column='ColoniaOrdenCliente')
